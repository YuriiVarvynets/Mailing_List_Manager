...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultPreviewSettings = {
            image: {width: "auto", height: "320px"},
            html: {width: "416px", height: "320px"},
            text: {width: "320px", height: "320px"},
            video: {width: "416px", height: "320px"},
            audio: {width: "416px", height: "80px"},
            flash: {width: "416px", height: "320px"},
            object: {width: "320px", height: "320px"},
            other: {width: "320px", height: "320px"}
        },
    ...
    FileInput.prototype = {
            ...
            self.$preview.find('.kv-file-remove').each(function () {
                ...
                $el.off('click').on('click', function () {
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        data: {csrfmiddlewaretoken: "{{ csrf_token }}", key: vKey, extraData: extraData},
        ...
        uploadExtra: function () {
            ...
            $.each(data, function (key, value) {
                ...
                self.formdata.append("csrfmiddlewaretoken", "{{ csrf_token }}");
            });
        },
